...
Use the Emergency simulation controls in the left panel: Gas leak, Fire / heat, Flooding, Equipment failure, or Clear emergency. These inject simulated telemetry abnormalities only; no real equipment is connected.
